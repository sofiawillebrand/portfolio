  ...
  return (
    ...
    <div className="header-container">
      ...
      <div className="header-text-container">
        <p className="header-name">portfolio: <span className="bold-style">sofia willebrand</span></p>
        <p className="header-title">frontend 
        <br/> developer</p>
        <p className="header-underscore color">+ ecologist </p>
        <p className="header-underscore">+ GIS Analyst </p>
      </div>
      <img src="./assets/profile-image.jpg" alt="profile of Sofia Willebrand" className="header-profile-image"/>
    </div>
  </header>
  )
}
